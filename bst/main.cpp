...
int main()
{
	...
	int heightNumber = intBST.height();
	cout << "The height is " << heightNumber << endl;

	int leafNumber = intBST.leafCount();
	cout << "The number of leaf's in the tree are " << leafNumber << endl;
